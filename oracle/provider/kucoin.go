...
func (p *KucoinProvider) GetTickerPrices(pairs ...types.CurrencyPair) (map[string]types.TickerPrice, error) {
...
func (p *KucoinProvider) getTickerPrice(key string) (types.TickerPrice, error) {
	p.mtx.Lock()
	defer p.mtx.Unlock()
