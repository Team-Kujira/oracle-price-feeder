...
func TestNewTicketPrice(t *testing.T) {
	...
	t.Run("when the inputs are valid", func(t *testing.T) {
		tickerPrice, err := NewTickerPrice("binance", "BTC", price, volume, -1)
